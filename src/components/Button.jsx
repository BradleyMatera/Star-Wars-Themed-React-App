...
const StyledButton = styled.button`
  background-color: ${(props) =>
    props.$primary
      ? "#1E90FF"
      : "#FFD700"}; // Sets the background color based on the $primary prop. If true, it uses a blue color, otherwise gold.
  color: ${(props) =>
    props.$primary
      ? "#fff"
      : "#000"}; // Sets the text color based on the $primary prop. If true, text is white, otherwise black.
  ...
  &:hover {
    background-color: ${(props) =>
      props.$primary
        ? "#104E8B"
        : "#DAA520"}; // Sets the hover background color based on the $primary prop. If true, it uses a darker blue color, otherwise darker gold.
  }
`;
